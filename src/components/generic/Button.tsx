...
export const PlayPauseButton = ({ onClick, disabled, isRunning }: CustomButtonProps) => (
    <Button onClick={onClick} disabled={disabled}>
        {/* icon svg from icons8.com */}
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={`w-10 h-10 ${isRunning ? 'text-lime-200' : ''}`}>
